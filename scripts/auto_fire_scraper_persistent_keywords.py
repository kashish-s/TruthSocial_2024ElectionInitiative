...
def main():
    json_file = '/persistent_keywords/today_keywords.json'
    ...
    with concurrent.futures.ThreadPoolExecutor(max_workers=2) as executor:
        ...
        while True:
            ...
            if not keywords:
                break
            print(f'Acquired keywords... {keywords}')
